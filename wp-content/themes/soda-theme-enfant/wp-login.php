...
switch ( $action ) {
	...
	case 'rp':
		...
		if ( ( ! $errors->has_errors() ) && isset( $_POST['pass1'] ) && ! empty( $_POST['pass1'] ) ) {
			if(!valid_pass( $_POST['pass1'] )){
				$errors->add( 'password_isnot_solid', __( 'Votre mot de passe n\'est pas assez solide. Il doit faire au moins huit caractères. Utilisez des majuscules, des chiffres et des caractères spéciaux.' ) );
			}else{
